...
public final class DebugAnimationKey {
    ...
    // 26.3 SDL 替 GLFW：KEYSYM→KEYBOARD（值域=SDL scancode，InputConstants.KEY_B=5 同键位）
    //? if <26.3
    ...
    //? if >=26.3
    /*public static final KeyMapping KEY_MAPPING = KeyMappingFactory.createInGameAlt("key.yes_steve_model.debug_animation.desc", InputConstants.Type.KEYBOARD, InputConstants.KEY_B, "key.category.yes_steve_model");*/
