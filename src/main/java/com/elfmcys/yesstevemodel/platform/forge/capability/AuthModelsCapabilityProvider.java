...
//?}
    ...
    public static void registerCapability() {
        CapabilityManager.INSTANCE.register(AuthModelsCapability.class, new Capability.IStorage<AuthModelsCapability>() {
            @Override
            public Tag writeNBT(Capability<AuthModelsCapability> capability, AuthModelsCapability instance, Direction side) {
                return new CompoundTag();
            }

            @Override
            public void readNBT(Capability<AuthModelsCapability> capability, AuthModelsCapability instance, Direction side, Tag nbt) {
            }
        }, () -> null);
    }*/
//?}
