...
public class ProjectileCapabilityProvider implements ICapabilityProvider {
    ...
    //?} else {
    /*@CapabilityInject(ProjectileCapability.class)
    public static Capability<ProjectileCapability> PROJECTILE_CAP = null;*/
//?}
    ...
    public static void registerCapability() {
        CapabilityManager.INSTANCE.register(ProjectileCapability.class, new Capability.IStorage<ProjectileCapability>() {
            @Override
            public Tag writeNBT(Capability<ProjectileCapability> capability, ProjectileCapability instance, Direction side) {
                return new CompoundTag();
            }

            @Override
            public void readNBT(Capability<ProjectileCapability> capability, ProjectileCapability instance, Direction side, Tag nbt) {
            }
        }, () -> null);
    }*/
//?}
