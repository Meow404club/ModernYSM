...
//?}
    ...
    public static void registerCapability() {
        CapabilityManager.INSTANCE.register(StarModelsCapability.class, new Capability.IStorage<StarModelsCapability>() {
            @Override
            public Tag writeNBT(Capability<StarModelsCapability> capability, StarModelsCapability instance, Direction side) {
                return new CompoundTag();
            }

            @Override
            public void readNBT(Capability<StarModelsCapability> capability, StarModelsCapability instance, Direction side, Tag nbt) {
            }
        }, () -> null);
    }*/
//?}
