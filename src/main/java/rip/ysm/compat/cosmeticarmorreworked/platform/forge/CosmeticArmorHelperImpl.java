package rip.ysm.compat.cosmeticarmorreworked.platform.forge;

import net.minecraft.world.entity.EquipmentSlot;
import net.minecraft.world.entity.LivingEntity;
import net.minecraft.world.item.ItemStack;
import com.elfmcys.yesstevemodel.client.compat.cosmeticarmorreworked.platform.forge.CosmeticArmorHelper;
