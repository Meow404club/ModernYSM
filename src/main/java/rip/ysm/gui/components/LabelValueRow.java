...
public final class LabelValueRow extends OptionRow<Object> {
    ...
    protected void renderWidget(YsmGui g, int mouseX, int mouseY, float partialTick) {
        ...
        Component label = YsmGui.trans(labelKey).withStyle(ChatFormatting.AQUA);
        ...
        g.drawString(Minecraft.getInstance().font, YsmGui.text(value), getX() + 8 + labelW + 6, getY() + (height - 8) / 2, 0xFFCCCCCC, false);
    }
