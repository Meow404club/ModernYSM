...
/**
 * neoforge 孪生（同 FQCN；RAW 源集，1.20.5+ 代，1.20.4 版在 src/neoforge-1204/java）。断裂=@EventBusSubscriber 删除→fml.common.EventBusSubscriber（1.20.6 文档+oldtest 实证）。RenderPlayerEvent.Pre 可取消
