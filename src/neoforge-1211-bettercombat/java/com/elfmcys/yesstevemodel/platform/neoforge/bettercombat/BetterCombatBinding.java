...
/**
 * 1.20.1-forge BetterCombatBinding 直译（javap 两代比对零断裂——ATTACK_START/
 * AttackHand.isOffHand/AttackAnimationSubStack.base 逐符号同形，见孪生门面头注）。
 * attackAnimation 字段（bettercombat mixin 注入 AbstractClientPlayer）反射探测，
 * 缺失即不挂钩。
 */
