...
import net.neoforged.neoforge.client.event.RenderLevelStageEvent.AfterBlockEntities;
...
public final class RenderFirstPlayerForgeHook {
    ...
    @SubscribeEvent
    public static void onRenderLevelStage(AfterBlockEntities event) {
        // 1.21.8 RenderLevelStageEvent 抽象化+Stage 枚举删 → 子事件类直接定档（AfterBlockEntities；
        // 旧 AFTER_CUTOUT_BLOCKS 无精确后继，取世界块实体后、半透明前的最后一档，语义差入功能债）
